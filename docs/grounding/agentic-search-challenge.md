...
- `Doc ID`: `grounding.agentic-search-challenge`
- `Version`: `1.0.0`
- `Status`: `authoritative`
- `Kind`: `source-text`
- `Last Updated`: `2026-04-02`
- `Authority`: This is the binding source text for the challenge prompt and should override conflicting summaries or paraphrases.
- `Supersedes`: `none`

This file preserves the exact challenge brief we are grounding the project against.
